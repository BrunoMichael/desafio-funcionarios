    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                {{-- Mensagem de sucesso via session, controlada pelo Livewire --}}
                @if (session()->has('message'))
                    <div class="bg-green-100 dark:bg-green-900 border border-green-400 dark:border-green-700 text-green-700 dark:text-green-100 px-4 py-3 rounded relative mb-4" role="alert">
                        ...
                        {{-- Botão para fechar a mensagem (JS puro) --}}
                ...
                {{-- Mensagem de erro via session, controlada pelo Livewire --}}
                ...
                {{-- Input de busca com binding do Livewire, que atualiza a propriedade 'search' com debounce de 300ms --}}
                <div class="flex flex-col sm:flex-row justify-between items-center mb-4 space-y-4 sm:space-y-0 sm:space-x-4">
                    ...
                    {{-- Botão que leva para a página de criação de funcionário --}}
                ...
                {{-- Tabela responsiva com listagem dos funcionários --}}
                <div class="overflow-x-auto relative shadow-md sm:rounded-lg scrollbar-dark">
                    <table class="w-full text-sm text-left text-gray-700 dark:text-gray-300">
                        ...
                        <tr>
                            ...
                            {{-- Cabeçalhos da tabela com ordenação via Livewire --}}
                            @foreach (['nome', 'email', 'cpf', 'cargo', 'dataAdmissao', 'salario'] as $field)
                                <th scope="col" class="py-3 px-6 cursor-pointer" wire:click="sortBy('{{ $field }}')">
                                    ...
                                    {{-- Indicador de direção da ordenação --}}
                                    @if ($sortBy === $field)
                        ...
                        @forelse ($funcionarios as $funcionario)
                            <tr class="bg-white dark:bg-gray-800 border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                <td class="py-4 px-6 whitespace-nowrap space-x-4 flex items-center">
                                    ...
                                    {{-- Botão para confirmar exclusão, dispara evento Livewire --}}
                ...
                {{-- Paginação gerada pelo Livewire --}}
                <div class="mt-4">
                    {{ $funcionarios->links() }}
                </div>

                {{-- Modal de confirmação para exclusão, usando Alpine.js para controle da abertura --}}
                    ...
                    <div x-data="{ open: @entangle('confirmingFuncionarioDeletion') }" x-show="open"
                        ...
                        <div x-show="open"
                            ...
                            <div class="flex justify-end space-x-4">
                                {{-- Botão cancelar que fecha o modal e chama metodo Livewire --}}
                                ...
                                {{-- Botão confirmar exclusão que chama metodo Livewire --}}
